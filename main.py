...
from fillers.filler import initialize_system, get_best_k_completions


def run_program():
    # Pass the archive path as required by the contract
    ...
    while True:
        ...
        # trie is NOT passed here according to the contract
